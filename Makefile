...
# LDFLAGS injects the VERSION into the binary at link time.
LDFLAGS ?= -X github.com/patrickdk77/endpoint-monitoring-operator/internal/version.Version=$(VERSION)
